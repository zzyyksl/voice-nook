...
- **黑曜石**（夜间）：多雷雕版画天使打底，深色玻璃卡片，底部玻璃录音长条，白色呼吸光圈
- **小花园**（日间）：奶油纸底，手绘藤蔓录音长条，木牌标题（有只黑猫），水彩盆栽
- 录音键在屏幕底部通栏，历史记录再长也不用翻回去按
- 标签栏右上角「夜／日」钮一键切换，选择会记住
- 图片素材独立文件 + 7 天强缓存：页面本体 24KB 秒开，图片只下载一次

全新安装看 [`themes/美化篇.txt`](themes/美化篇.txt)；老版本升级看 [`themes/更新篇.txt`](themes/更新篇.txt)——把教程和文件直接发给你家机，它自己会更。
